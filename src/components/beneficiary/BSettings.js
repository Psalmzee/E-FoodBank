        ...
        <div className="container">
          <div className="row">
            <div className="col-3 admin-side-left pt-5 shadow">
              <Link to="/myprofile"><i className="far fa-user-circle"></i>&nbsp;&nbsp; Profile</Link>
              <Link to="/myprofile"><i class="far fa-bell"></i>&nbsp;&nbsp; Notifications</Link>
              <Link to="/myprofile/settings" className="admin-side-active my-1"><i class="fas fa-cog"></i>&nbsp;&nbsp; Settings</Link>
